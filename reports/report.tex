...
We assume that the reader is familiar with the notion of Turing machine. In this paper, we only deal with deterministic Turing machines so it is what we mean when we use the expression \emph{Turing machine}.
